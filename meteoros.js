...
const drawMeteors = () => {
    ...
    setInterval(() => {
        ...
        let size = getRandom_max_min(meteorsSize,1); // meteor sizes will vary         
        ...
        meteoros.push(new Meteors(
            x, y, size,
            {
                dx : getRandom_max_min(meteorSpeed,-meteorSpeed),
                dy : getRandom_max_min(meteorSpeed,-meteorSpeed) 
            }
